...
if ( piquant_mikado_options()->getOptionValue('mkdf_woo_products_list_full_width') == 'yes' && !is_singular('product') ) {
	$full_width = true;
}

if ( $full_width ) { ?>
	<div class="mkdf-full-width" <?php piquant_mikado_inline_style($background_color); ?>>
<?php } else { ?>
	<div class="mkdf-container" <?php piquant_mikado_inline_style($background_color); ?>>
		<?php do_action('piquant_mikado_after_container_open'); ?>
<?php }
		if ( $full_width ) { ?>
			<div class="mkdf-full-width-inner" <?php piquant_mikado_inline_style($content_style); ?>>
		<?php } else { ?>
			<div class="mkdf-container-inner clearfix" <?php piquant_mikado_inline_style($content_style); ?>>
		<?php }
			...
			if ( ! is_singular('product') ) {
				...
				switch( $sidebar ) {
						...
						<div class="mkdf-two-columns-66-33 grid2 mkdf-page-sidebar mkdf-woocommerce-with-sidebar clearfix">
							<div class="mkdf-column1">
								<div class="mkdf-column-inner">
									<?php piquant_mikado_woocommerce_content(); ?>
								</div>
							</div>
					...
					<?php
						break;
					default:
						piquant_mikado_woocommerce_content();
				}
