...
/*
  Class: PiquantMikadoIconCollections
...
class PiquantMikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new PiquantMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new PiquantMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new PiquantMikadoIconsIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new PiquantMikadoIconsLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new PiquantMikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new PiquantMikadoDripicons('Dripicons', 'dripicon'));
    }
...
$mkdPiquantIconCollections = PiquantMikadoIconCollections::get_instance();