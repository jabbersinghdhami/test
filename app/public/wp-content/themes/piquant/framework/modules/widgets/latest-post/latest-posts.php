...
class PiquantMikadoLatestPosts extends PiquantMikadoWidget {
	protected $params;
	public function __construct() {
		parent::__construct(
			'mkdf_latest_posts_widget', // Base ID
			'Mikado Latest Post', // Name
			array( 'description' => esc_html__( 'Display posts from your blog', 'piquant'), ) // Args
		);
	...
	public function widget($args, $instance) {
		...
		echo piquant_mikado_execute_shortcode('mkdf_blog_list', $params);
