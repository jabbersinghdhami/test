...
if ( ! function_exists('piquant_mikado_title_options_map') ) {

	function piquant_mikado_title_options_map() {
		...
		$panel_title = piquant_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
		...
		$show_title_area_container = piquant_mikado_add_admin_container(
			array(
				'parent' => $panel_title,
		...
		$title_area_type_container = piquant_mikado_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		$title_area_background_image_responsive_container = piquant_mikado_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		$panel_typography = piquant_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
		...
		$group_page_title_styles = piquant_mikado_add_admin_group(array(
		...
		$row_page_title_styles_1 = piquant_mikado_add_admin_row(array(
		...
		$row_page_title_styles_2 = piquant_mikado_add_admin_row(array(
		...
		$group_page_subtitle_styles = piquant_mikado_add_admin_group(array(
		...
		$row_page_subtitle_styles_1 = piquant_mikado_add_admin_row(array(
		...
		$row_page_subtitle_styles_2 = piquant_mikado_add_admin_row(array(
		...
		$group_page_breadcrumbs_styles = piquant_mikado_add_admin_group(array(
		...
		$row_page_breadcrumbs_styles_1 = piquant_mikado_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_2 = piquant_mikado_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_3 = piquant_mikado_add_admin_row(array(
	...
	add_action( 'piquant_mikado_options_map', 'piquant_mikado_title_options_map', 6);
}