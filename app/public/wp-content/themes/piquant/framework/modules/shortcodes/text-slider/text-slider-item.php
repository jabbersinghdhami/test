<?php
namespace Piquant\MikadofModules\Shortcodes\TextSliderItem;
...
class TextSliderItem implements ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        $html = piquant_mikado_get_shortcode_module_template_part('templates/text-slider-item-template', 'text-slider', '', $params);
