<?php
namespace Piquant\MikadofModules\Shortcodes\TextSliderHolder;
...
class TextSliderHolder implements ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        $html = piquant_mikado_get_shortcode_module_template_part('templates/text-slider-holder-template', 'text-slider', '', $params);
