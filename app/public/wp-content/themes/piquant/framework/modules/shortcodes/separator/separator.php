<?php
namespace Piquant\MikadofModules\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html = piquant_mikado_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(piquant_mikado_string_ends_with($params['width'], '%') || piquant_mikado_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(piquant_mikado_string_ends_with($params['top_margin'], '%') || piquant_mikado_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(piquant_mikado_string_ends_with($params['bottom_margin'], '%') || piquant_mikado_string_ends_with($params['bottom_margin'], 'px')) {
