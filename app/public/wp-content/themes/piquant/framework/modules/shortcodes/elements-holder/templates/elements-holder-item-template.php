<div class="mkdf-elements-holder-item <?php echo esc_attr($elements_holder_item_class); ?>" <?php echo piquant_mikado_get_inline_attrs($elements_holder_item_data); ?> <?php echo piquant_mikado_get_inline_style($elements_holder_item_style); ?>>
	<div class="mkdf-elements-holder-item-inner">
		<div class="mkdf-elements-holder-item-content <?php echo esc_attr($elements_holder_item_content_class); ?>" <?php echo piquant_mikado_get_inline_style($elements_holder_item_content_style); ?>>
