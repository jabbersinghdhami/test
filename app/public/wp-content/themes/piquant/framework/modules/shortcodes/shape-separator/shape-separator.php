<?php
namespace Piquant\MikadofModules\Shortcodes\ShapeSeparator;
...
class ShapeSeparator implements ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        return piquant_mikado_get_shortcode_module_template_part('templates/shape-separator-template', 'shape-separator', '', $params);
    }
    ...
    private function getHolderStyles($params) {
        ...
        if(!empty($params['top_margin'])) {
            $styles[] = 'margin-top: '.piquant_mikado_filter_px($params['top_margin']).'px';
        }

        if(!empty($params['bottom_margin'])) {
            $styles[] = 'margin-bottom: '.piquant_mikado_filter_px($params['bottom_margin']).'px';
        }
