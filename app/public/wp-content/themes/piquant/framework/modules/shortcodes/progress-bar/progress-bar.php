<?php
namespace Piquant\MikadofModules\ProgressBar;
...
class ProgressBar implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
        ...
        //init variables
		$html = piquant_mikado_get_shortcode_module_template_part('templates/progress-bar-template', 'progress-bar', '', $params);
