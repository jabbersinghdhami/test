<?php
namespace Piquant\MikadofModules\PricingTable;
...
class PricingTable implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html .= piquant_mikado_get_shortcode_module_template_part('templates/pricing-table-template', 'pricing-table', '', $params);
		return $html;
