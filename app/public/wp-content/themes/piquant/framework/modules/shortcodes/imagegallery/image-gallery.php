<?php
namespace Piquant\MikadofModules\Shortcodes\ImageGallery;
...
class ImageGallery implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(array(
			...
			'params'                    => array(
				...
				array(
					'type'			=> 'dropdown',
					'heading'		=> 'Display info on hover',
					'param_name'	=> 'info_on_hover',
					'value' => array(
						'Yes' => 'yes',
						'No' => 'no'
					),
					...
					'description' => 'Displays image title.'
				),
				array(
					'type'			=> 'dropdown',
	...
	public function render($atts, $content = null) {
		...
		$html = piquant_mikado_get_shortcode_module_template_part('templates/' . $template, 'imagegallery', '', $params);
	...
	private function getGalleryClasses($params) {
	 	...
	 	if ($params{'info_on_hover'} == 'yes') {
	 		$gallery_classes[] = 'mkdf-info-on-hover';
	 	}
