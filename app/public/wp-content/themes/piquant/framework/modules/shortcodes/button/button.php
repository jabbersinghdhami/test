<?php
namespace Piquant\MikadofModules\Shortcodes\Button;
 ...
 * @package Piquant\MikadofModules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
            ...
            'params'                    => array_merge(
                ...
                array(
                    ...
                    array(
                        ...
                        'value'       => array_flip(piquant_mikado_get_font_weight_array(true)),
                        'admin_label' => true,
                        'group'       => 'Design Options',
                        'save_always' => true
                    ),
                    array(
                        ...
                        'heading'     => 'Margin',
                        'param_name'  => 'margin',
                        'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'piquant'),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    ),
                    array(
                        ...
                        'admin_label' => true,
                        'group'       => 'Design Options',
                        'value'       => array_flip(piquant_mikado_get_text_transform_array(true))
                    )
                )
            ) //close array_merge
        ));
    ...
    public function render($atts, $content = null) {
        ...
        if($params['text'] !== '') {
            return piquant_mikado_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
        }
    }
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.piquant_mikado_filter_px($params['font_size']).'px';
        }
    ...
    private function getButtonDataAttr($params) {
        ...
        if(!empty($params['icon_hover_border_color'])) {
            $data['data-icon-hover-border-color'] = $params['icon_hover_border_color'];
        }
    ...
    private function getButtonClasses($params) {
        ...
        if(!empty($params['icon_hover_border_color'])) {
            $buttonClasses[] = 'mkdf-btn-custom-icon-border-hover';
        }
