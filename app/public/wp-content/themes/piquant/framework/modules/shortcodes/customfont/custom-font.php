<?php
namespace Piquant\MikadofModules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
		...
		vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						"value" => piquant_mikado_get_font_style_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
					...
					array(
						...
						"value" => piquant_mikado_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = piquant_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
