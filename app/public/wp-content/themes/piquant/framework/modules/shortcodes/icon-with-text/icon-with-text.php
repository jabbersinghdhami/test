<?php
namespace Piquant\MikadofModules\Shortcodes\IconWithText;

use Piquant\MikadofModules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package Piquant\MikadofModules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
        ...
        vc_map(array(
            ...
            'params'                    => array_merge(
                ...
                array(
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => 'Margin For Custom Icon',
                        'param_name'  => 'custom_margin',
                        'value'       => '',
                        'description' => 'Set margin for your custom icon in format: top right bottom left',
                        'dependency' => array('element' => 'custom_icon', 'not_empty' => true)
    ...
    public function render($atts, $content = null) {
        ...
        return piquant_mikado_get_shortcode_module_template_part('templates/iwt', 'icon-with-text', $params['icon_position'], $params);
    }
    ...
    private function getHolderClasses($params) {
        ...
        if(!empty($params['custom_icon']) && !empty($params['custom_hover_icon'])) {
    ...
    private function getContentStyles($params) {
        ...
        if($params['icon_position'] == 'left' && !empty($params['text_left_padding'])) {
            $styles[] = 'padding-left: '.piquant_mikado_filter_px($params['text_left_padding']).'px';
        }

        if($params['icon_position'] == 'right' && !empty($params['text_right_padding'])) {
            $styles[] = 'padding-right: '.piquant_mikado_filter_px($params['text_right_padding']).'px';
        }
    ...
    private function getCustomIconStyles($params) {
        ...
        if($params['custom_margin'] !== '') {
            $custom_styles[] = 'margin: '.$params['custom_margin'];
        }
