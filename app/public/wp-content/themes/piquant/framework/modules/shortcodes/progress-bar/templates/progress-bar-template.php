...
<div class="mkdf-progress-content-outer" <?php piquant_mikado_inline_style($inactive_bar_style); ?>>
	<div data-percentage=<?php echo esc_attr($percent)?> class="mkdf-progress-content" <?php piquant_mikado_inline_style($bar_styles); ?>></div>
</div>
</div>	