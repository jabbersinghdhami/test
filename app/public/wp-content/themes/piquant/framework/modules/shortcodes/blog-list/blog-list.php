...
namespace Piquant\MikadofModules\BlogList;
...
class BlogList implements ShortcodeInterface {
	...
	*/
		...
		vc_map( array(
			...
			'params' => array(
					array(
						...
						'holder' => 'div',
						'class' => '',
						'heading' => esc_html__('Type', 'piquant'),
						'param_name' => 'type',
						'value' => array(
							'Grid' => 'boxes',
							'Masonry' => 'masonry',
	...
	public function render($atts, $content = null) {
		...
		$html ='';
        $html .= piquant_mikado_get_shortcode_module_template_part('templates/blog-list-holder', 'blog-list', '', $params);
		return $html;
