<?php
namespace Piquant\MikadofModules\Shortcodes\IconSlider;
...
class IconSliderItem implements ShortcodeInterface {
    ...
    public function vcMap() {
        $iconCollections = piquant_mikado_icon_collections()->iconCollections;
            ...
            'params'                  => array_merge(
                array(
                    array(
                        ...
                        'value'       => piquant_mikado_icon_collections()->getIconCollectionsVC(),
                        'save_always' => true
                    ),
                ),
                $iconsArray,
    ...
    public function render($atts, $content = null) {
        ...
        return piquant_mikado_get_shortcode_module_template_part('templates/icon-slider-item', 'icon-slider', '', $params);
    }
}