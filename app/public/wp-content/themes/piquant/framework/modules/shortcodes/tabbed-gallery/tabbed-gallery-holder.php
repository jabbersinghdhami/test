...
class TabbedGalleryHolder implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			...
			'params'                  => array_merge(
				...
				piquant_mikado_icon_collections()->getVCParamsArray(array(), '', true, 'Button Icon Pack', 'Button Icon')
			)
		));
	}
	...
	public function render($atts, $content = null) {
		...
		return piquant_mikado_get_shortcode_module_template_part('templates/tabbed-gallery-holder-template', 'tabbed-gallery', '', $params);
	}
	...
	private function getButtonParams($params) {
		...
		$btn_params['size']                   = 'small';
		$btn_params['type']                   = 'white';
