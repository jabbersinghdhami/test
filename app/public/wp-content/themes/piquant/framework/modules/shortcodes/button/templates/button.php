<button type="submit" <?php piquant_mikado_inline_style($button_styles); ?> <?php piquant_mikado_class_attribute($button_classes); ?> <?php echo piquant_mikado_get_inline_attrs($button_data); ?> <?php echo piquant_mikado_get_inline_attrs($button_custom_attrs); ?>>
    <?php if($show_icon) : ?>
