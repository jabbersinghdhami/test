<?php
namespace Piquant\MikadofModules\Shortcodes\TwitterSlider;
...
class TwitterSlider implements ShortcodeInterface {
        ...
        vc_map(array(
            ...
            'params'                    => array(
                ...
                array(
                    ...
                    'value'       => '',
                    'description' => esc_html__('Speed of slide animation in miliseconds', 'piquant'),
                    'admin_label' => true
                )
            )
        ));
    ...
    public function render($atts, $content = null) {
        ...
        if($twitter_api->hasUserConnected()) {
            ...
            $html .= piquant_mikado_get_shortcode_module_template_part('templates/twitter-slider', 'twitter-slider', '', $params);
        } else {
            $html .= esc_html__('It seams that you haven\'t connected with your Twitter account', 'piquant');
        }
