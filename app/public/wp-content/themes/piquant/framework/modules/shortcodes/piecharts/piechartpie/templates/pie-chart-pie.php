<div class="mkdf-pie-chart-pie-holder">
	<div class="mkdf-pie-chart-pie">
		<canvas id="pie<?php echo esc_attr($id); ?>" class="mkdf-pie" height="<?php echo esc_html($height); ?>" width="<?php echo esc_html($width); ?>" <?php echo piquant_mikado_get_inline_attrs($pie_chart_data)?>></canvas>
	</div>
