...
if(!function_exists('piquant_mikado_footer_options_map')) {
	/**
	 * Add footer options
	 */
	function piquant_mikado_footer_options_map() {
		...
		$footer_panel = piquant_mikado_add_admin_panel(
			array(
				'title' => 'Footer',
				'name'  => 'footer',
				'page'  => '_footer_page'
		...
		$show_footer_top_container = piquant_mikado_add_admin_container(
			array(
		...
		$show_footer_bottom_container = piquant_mikado_add_admin_container(
			array(
	...
	add_action('piquant_mikado_options_map', 'piquant_mikado_footer_options_map', 8);
