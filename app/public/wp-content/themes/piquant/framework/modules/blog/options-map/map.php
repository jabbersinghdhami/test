...
if(!function_exists('piquant_mikado_blog_options_map')) {

	function piquant_mikado_blog_options_map() {
		...
		$panel_blog_lists = piquant_mikado_add_admin_panel(
			array(
				'page'  => '_blog_page',
		...
		piquant_mikado_add_admin_field(array(
			...
			'options'       => array(
				...
				'standard-date-on-side' => 'Blog: Standard With Date on Side',
		...
		$pagination_container = piquant_mikado_add_admin_container(
			array(
		 ...
		 * Blog Single
		 */
		$panel_blog_single = piquant_mikado_add_admin_panel(
			array(
				'page'  => '_blog_page',
		...
		$blog_single_navigation_container = piquant_mikado_add_admin_container(
			array(
		...
		$blog_single_author_info_container = piquant_mikado_add_admin_container(
			array(
	...
	add_action('piquant_mikado_options_map', 'piquant_mikado_blog_options_map', 15);
