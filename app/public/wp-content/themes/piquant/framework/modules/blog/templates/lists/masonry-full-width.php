...
<div class="mkdf-blog-holder mkdf-blog-type-masonry mkdf-masonry-full-width mkdf-masonry-pagination-<?php echo esc_attr(piquant_mikado_options()->getOptionValue('masonry_pagination')); ?>">
