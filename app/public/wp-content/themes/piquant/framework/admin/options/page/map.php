...
if ( ! function_exists('piquant_mikado_page_options_map') ) {

    function piquant_mikado_page_options_map() {
        ...
        $panel_sidebar = piquant_mikado_add_admin_panel(
            array(
                'page'  => '_page_page',
                'name'  => 'panel_sidebar',
                'title' => 'Design Style'
        ...
        //#sidebar
        $panel_widgets = piquant_mikado_add_admin_panel(
            array(
                'page'  => '_page_page',
                'name'  => 'panel_widgets',
                'title' => 'Widgets'
        ...
        $group_sidebar_padding = piquant_mikado_add_admin_group(array(
            'name'   => 'group_sidebar_padding',
            'title'  => 'Padding',
            'parent' => $panel_widgets
        ));

        $row_sidebar_padding = piquant_mikado_add_admin_row(array(
    ...
    add_action( 'piquant_mikado_options_map', 'piquant_mikado_page_options_map', 6);
