...
if ( ! function_exists('piquant_mikado_fonts_options_map') ) {
	/**
	 * Font options page
	 */
	function piquant_mikado_fonts_options_map() {
		 ...
		 * Headings
		 */
		$panel_headings = piquant_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => 'Headings'
		...
		//H1
		$group_heading_h1 = piquant_mikado_add_admin_group(array(
		...
		$row_heading_h1_1 = piquant_mikado_add_admin_row(array(
		...
		$row_heading_h1_2 = piquant_mikado_add_admin_row(array(
		...
		//H2
		$group_heading_h2 = piquant_mikado_add_admin_group(array(
		...
		$row_heading_h2_1 = piquant_mikado_add_admin_row(array(
		...
		$row_heading_h2_2 = piquant_mikado_add_admin_row(array(
		...
		//H3
		$group_heading_h3 = piquant_mikado_add_admin_group(array(
		...
		$row_heading_h3_1 = piquant_mikado_add_admin_row(array(
		...
		$row_heading_h3_2 = piquant_mikado_add_admin_row(array(
		...
		//H4
		$group_heading_h4 = piquant_mikado_add_admin_group(array(
		...
		$row_heading_h4_1 = piquant_mikado_add_admin_row(array(
		...
		$row_heading_h4_2 = piquant_mikado_add_admin_row(array(
		...
		//H5
		$group_heading_h5 = piquant_mikado_add_admin_group(array(
		...
		$row_heading_h5_1 = piquant_mikado_add_admin_row(array(
		...
		$row_heading_h5_2 = piquant_mikado_add_admin_row(array(
		...
		//H6
		$group_heading_h6 = piquant_mikado_add_admin_group(array(
		...
		$row_heading_h6_1 = piquant_mikado_add_admin_row(array(
		...
		$row_heading_h6_2 = piquant_mikado_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = piquant_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
				'title' => 'Text'
		...
		$group_text = piquant_mikado_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> 'Paragraph',
		...
		$row_text_1 = piquant_mikado_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$row_text_2 = piquant_mikado_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_link = piquant_mikado_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> 'Links',
		...
		$row_link_1 = piquant_mikado_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		$row_link_2 = piquant_mikado_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		piquant_mikado_add_admin_field(array(
			...
			'options'		=> piquant_mikado_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	...
	add_action( 'piquant_mikado_options_map', 'piquant_mikado_fonts_options_map', 2);
