...
$slider_meta_box = piquant_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
...
$video_meta_box = piquant_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
    ...
    $slide_video_overlay_container = piquant_mikado_add_admin_container(array(
...
$general_meta_box = piquant_mikado_add_meta_box(
    ...
    $slide_hide_title_container = piquant_mikado_add_admin_container(array(
        ...
        $group_title_link = piquant_mikado_add_admin_group(array(
            'title' => 'Title Link',
            ...
            $row1 = piquant_mikado_add_admin_row(array(
                'name' => 'row1',
    ...
    $group_button1 = piquant_mikado_add_admin_group(array(
        'title' => 'Button 1 Link',
        'name' => 'group_button1',
        'parent' => $general_meta_box
    ));
    ...
    $group_button2 = piquant_mikado_add_admin_group(array(
        'title' => 'Button 2 Link',
        'name' => 'group_button2',
        'parent' => $general_meta_box
    ));
...
$behaviours_meta_box = piquant_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
    ...
    $enable_image_animation_container = piquant_mikado_add_admin_container(array(
    ...
    $slide_content_animation_container = piquant_mikado_add_admin_container(array(
...
$content_positioning_meta_box = piquant_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
    ...
    $slide_content_vertical_middle_yes_container = piquant_mikado_add_admin_container(array(
        ...
        $group_space_around_content = piquant_mikado_add_admin_group(array(
    ...
    $slide_content_vertical_middle_no_container = piquant_mikado_add_admin_container(array(
        ...
        $slide_content_width_container = piquant_mikado_add_admin_container(array(
        ...
        $group_space_around_content = piquant_mikado_add_admin_group(array(
            ...
            $row2 = piquant_mikado_add_admin_row(array(
                'name' => 'row2',
                'parent' => $group_space_around_content
            ));

                $content_vertical_positioning_group_container = piquant_mikado_add_admin_container_no_style(array(
        ...
        $slide_graphic_positioning_container = piquant_mikado_add_admin_container(array(
            ...
            $group_graphic_positioning = piquant_mikado_add_admin_group(array(
