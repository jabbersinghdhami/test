...
class PiquantMikadoSkin extends PiquantMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to piquant_mikado_admin_scripts_init and piquant_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('piquant_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('piquant_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('piquant_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('piquant_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('piquant_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('piquant_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            piquant_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            piquant_mikado_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        $tab    		= piquant_mikado_get_admin_tab();
        $active_page 	= piquant_mikado_framework()->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param PiquantMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkdf-options-page mkdf-page">
            <?php $this->getHeader(piquant_mikado_get_theme_info_item('Name'), piquant_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkdf-page-content-wrapper">
                <div class="mkdf-page-content">
                    <div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
