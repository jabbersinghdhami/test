...
if(!function_exists('piquant_mikado_styles')) {
	...
	function piquant_mikado_styles() {
		...
		if(piquant_mikado_load_woo_assets()) {
			$style_dynamic_deps_array = array('piquant_mikado_woocommerce', 'piquant_mikado_woocommerce_responsive');
		}
...
if(!function_exists('piquant_mikado_scripts')) {
	...
	function piquant_mikado_scripts() {
		...
		wp_enqueue_script('piquant_mikado_modules', MIKADO_ASSETS_ROOT.'/js/modules.min.js', array('jquery'), false, true);
